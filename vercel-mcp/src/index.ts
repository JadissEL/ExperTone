...
function runVercel(args: string[], cwd?: string): string {
...
server.registerTool(
  ...
  async (args) => {
    ...
    if (args.yes !== false) cmdArgs.push('--yes');
    const output = runVercel(cmdArgs, cwd);
    return {
...
server.registerTool(
  ...
  async (args) => {
    ...
    if (args.output === 'json') cmdArgs.push('--output', 'json');
    const output = runVercel(cmdArgs, cwd);
    return {
...
server.registerTool(
  ...
  async (args) => {
    ...
    if (args.environment) cmdArgs.push(args.environment);
    const output = runVercel(cmdArgs, cwd);
    return {
...
server.registerTool(
  ...
  async (args) => {
    ...
    if (args.deployment) cmdArgs.push(args.deployment);
    const output = runVercel(cmdArgs, cwd);
    return {
